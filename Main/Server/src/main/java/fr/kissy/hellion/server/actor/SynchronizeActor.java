...
public class SynchronizeActor extends UntypedActor {
    ...
    public void onReceive(Object o) throws Exception {
        ...
        } else if (o instanceof WorldActor.NearEntitiesResponse) {
            Player player = ((WorldActor.NearEntitiesResponse) o).getPlayer();
            Set<Player> nearPlayers = ((WorldActor.NearEntitiesResponse) o).getPlayers();

package fr.kissy.helion.server.config;

import fr.kissy.helion.server.realm.ShiroBaseRealm;
...
@Configuration
@ImportResource("classpath:/fr/kissy/helion/server/properties-config.xml")

...
#include "Action/OISBAnalogAxisAction.h"
#include "OISBAnalogEmulation.h"
#include "OISBBinding.h"
#include "State/OISBDigitalState.h"
#include "State/OISBAnalogAxisState.h"
...
namespace OISB {
    ...
    void AnalogAxisAction::setUseCircularValues(bool use) {
        mUseCircularValues = use;
    }
    ...
    void AnalogAxisAction::listProperties(PropertyList& list) {
        ...
        list.push_back("UseCircularValues");
    ...
    void AnalogAxisAction::impl_setProperty(const String& name, const String& value) {
        ...
        } else if (name == "UseCircularValues") {
            setUseCircularValues(fromString<bool>(value));
    ...
    String AnalogAxisAction::impl_getProperty(const String& name) const {
        if (name == "UseAbsoluteValues") {
            ...
            return toString(getUseCircularValues());
        } else if (name == "AbsoluteValue") {
    ...
    bool AnalogAxisAction::impl_process(Real delta) {
        ...
        if (mUseCircularValues) {
            if (mAbsoluteValue > mMaximumValue) {
                mAbsoluteValue -= mMaximumValue;
                mAbsoluteValue += mMinimumValue;
            } else if (mAbsoluteValue < mMinimumValue) {
                mAbsoluteValue += mMaximumValue;
                mAbsoluteValue -= mMinimumValue;
            }
        } else {

...
namespace OISB {
    ...
    class _OISBExport AnalogAxisAction : public Action {
        public:
            ...
            void setUseCircularValues(bool use);

            inline bool getUseCircularValues() const {
                return mUseCircularValues;
            }
        ...
        private:
            ...
            /// if true, the absolute value will be circular
            bool mUseCircularValues;

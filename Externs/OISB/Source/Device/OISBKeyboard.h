...
#ifndef __OISB_KEYBOARD_H__
#define __OISB_KEYBOARD_H__

#include "OISBGlobal.h"
#include "Device/OISBDevice.h"

namespace OISB {
    /**
     * @brief this class wraps OIS' keyboard
     *
     * @note you don't need to use this directly!
     */
    class _OISBExport Keyboard : public Device {
        public:
            ...
            /// @copydoc Device::update
            virtual void process(Real delta);

        private:
            /// pointer to implementation OIS' keyboard

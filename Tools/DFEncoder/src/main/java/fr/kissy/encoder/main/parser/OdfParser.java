 ...
 * @version $Id: OdfParser.java 7 2012-03-02 17:43:54Z kissy $
 */
public class OdfParser extends AbstractParser {
    ...
    private void parseSystemProperties(Element propertiesElement) throws XMLParseException {
        ...
        // Object properties
        getOdfBuidler().addObjectProperties(ParseUtils.parseObjectProperties(propertiesElement));
    }
     ...
     */
    public SdfProto.Sdf.Object.Builder getOdfBuidler() {
        return (SdfProto.Sdf.Object.Builder) builder;
    }

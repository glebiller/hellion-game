...
//
// How many Network commands do we want to buffer between updates
//
#define Network_BUFFER_SIZE 25
...
enum DEMO_ACTIONS {
    //
    // Discrete Network. This is for state events such as button or key presses.
    // Used by the keyboard, mouse buttons, and digital buttons on a gamepad.
    //
    Network_ACTION_1,
    Network_ACTION_2,
    //
    // Absolute axis Network. This is for the joystick-like devices which report absolute measurments.
    //
    Network_ABS_MOVE_FORWARDBACK_AXIS,    // Move along Z axis
    Network_ABS_MOVE_LEFTRIGHT_AXIS,      // Move along X axis
    Network_ABS_ROTATE_UPDOWN_AXIS,       // Rotate around X axis
    Network_ABS_ROTATE_LEFTRIGHT_AXIS,    // Rotate around Y axis
    Network_ABS_MOVE_UPDOWN,              // Move along Y axis

    //
    // Turn on/off the water hose.
    //
    Network_USE_WATERHOSE,

    Network_LEFT_CTRL,                    // Left Ctrl
    Network_RIGHT_CTRL,                   // Right Ctrl
    Network_MOVE_FORWARD,
    Network_MOVE_BACK,
    Network_MOVE_LEFT,
    Network_MOVE_RIGHT,
    Network_MOVE_UP,
    Network_MOVE_DOWN,
    Network_ACTION_TIMESTOP,
    Network_ACTION_TOGGLE_OVERLAY_1,
    Network_ACTION_TOGGLE_OVERLAY_2,
    Network_ACTION_TOGGLE_OVERLAY_3,
    Network_ACTION_TOGGLE_OVERLAY_4,
    Network_ACTION_TOGGLE_OVERLAY_5,
    Network_QUIT,
    Network_SHOW_POLYGONS,                // Ctrl + P
    Network_TOGGLE_NORMALS,               // Ctrl + N
    Network_TOGGLE_TANGENTS,              // Ctrl + T
    Network_TOGGLE_BOUNDING_BOX,          // Ctrl + B
    Network_TOGGLE_CAPTIONS,              // Ctrl + O
    Network_SET_THREAD_COUNT_1,           // Ctrl + 1
    Network_SET_THREAD_COUNT_2,           // Ctrl + 2
    Network_SET_THREAD_COUNT_4,           // Ctrl + 4
    Network_SET_THREAD_COUNT_MAX,         // Ctrl + X

    //
    // Relative axis Network. This is for the mouse-like devices which report changes since the last measurement
    //
    Network_REL_ROTATE_LEFTRIGHT_AXIS,  // Rotate around Y axis
    Network_REL_ROTATE_UPDOWN_AXIS,     // Rotate around X axis

    Network_NUM_ACTIONS,
    Network_INVALID_ACTION
};


//
// This is the action map that directNetwork will attempt to map to each device that is connected.  We define our generic name
// for the action along with a predefined value that DirectNetwork will use in an attempt to provide a proper mapping. This doesn't
// work so well so generic values are used for the most part (e.g. DIAXIS_ANY_1)
//
DIACTION g_rgGameAction[] = {
    // Device Network pre-defined by DirectNetwork, according to genre
    // joystick
    {Network_ACTION_1,                  DIBUTTON_MECHA_FIRE,    0,            _T("Reset view"),           },
    {Network_ACTION_2,                  DIBUTTON_MECHA_WEAPONS, 0,            _T("Enable movement"),      },
    {Network_ABS_MOVE_FORWARDBACK_AXIS, DIAXIS_ANY_1,           0,            _T("Move forward/back"),    },
    {Network_ABS_MOVE_LEFTRIGHT_AXIS,   DIAXIS_ANY_2,           0,            _T("Move left/right"),      },
    {Network_ABS_ROTATE_UPDOWN_AXIS,    DIAXIS_ANY_3,           0,            _T("Rotate up/down"),       },
    {Network_ABS_ROTATE_LEFTRIGHT_AXIS, DIAXIS_ANY_4,           0,            _T("Rotate left/right"),    },
    {Network_ABS_MOVE_UPDOWN,           DIAXIS_ANY_Z_1,         0,            _T("Move up/down"),         },

    // Keyboard Network mappings
    {Network_LEFT_CTRL,                 DIKEYBOARD_LCONTROL,    0,            _T("Left control key"),     },
    {Network_RIGHT_CTRL,                DIKEYBOARD_RCONTROL,    0,            _T("Right control key"),    },
    {Network_MOVE_FORWARD,              DIKEYBOARD_W,           0,            _T("MoveForward"),          },
    {Network_MOVE_BACK,                 DIKEYBOARD_S,           0,            _T("MoveBack"),             },
    {Network_MOVE_LEFT,                 DIKEYBOARD_A,           0,            _T("MoveLeft"),             },
    {Network_MOVE_RIGHT,                DIKEYBOARD_D,           0,            _T("MoveRight"),            },
    {Network_MOVE_UP,                   DIKEYBOARD_R,           0,            _T("MoveUp"),               },
    {Network_MOVE_DOWN,                 DIKEYBOARD_F,           0,            _T("MoveDown"),             },
    {Network_ACTION_1,                  DIKEYBOARD_C,           0,            _T("ResetView"),            },
    {Network_ACTION_TIMESTOP,           DIKEYBOARD_PAUSE,       0,            _T("Pause"),                },
    {Network_ACTION_TOGGLE_OVERLAY_1,   DIKEYBOARD_F1,          0,            _T("ToggleOverlay1"),       },
    {Network_ACTION_TOGGLE_OVERLAY_2,   DIKEYBOARD_F2,          0,            _T("ToggleOverlay2"),       },
    {Network_ACTION_TOGGLE_OVERLAY_3,   DIKEYBOARD_F3,          0,            _T("ToggleOverlay3"),       },
    {Network_ACTION_TOGGLE_OVERLAY_4,   DIKEYBOARD_F4,          0,            _T("ToggleOverlay4"),       },
    {Network_ACTION_TOGGLE_OVERLAY_5,   DIKEYBOARD_F5,          0,            _T("ToggleOverlay5"),       },
    {Network_QUIT,                      DIKEYBOARD_ESCAPE,      DIA_APPFIXED, _T("Quit"),                 },
    {Network_SHOW_POLYGONS,             DIKEYBOARD_P,           0,            _T("PolygonMode"),          },

    // Water System Network mapping
    {Network_USE_WATERHOSE,             DIKEYBOARD_SPACE,       0,            _T("UseFireHose"),        },

    {Network_TOGGLE_NORMALS,            DIKEYBOARD_N,           0,            _T("ShowNormals"),          },
    {Network_TOGGLE_TANGENTS,           DIKEYBOARD_T,           0,            _T("ShowTangents"),         },
    {Network_TOGGLE_BOUNDING_BOX,       DIKEYBOARD_B,           0,            _T("ShowBoundingBox"),      },
    {Network_TOGGLE_CAPTIONS,           DIKEYBOARD_O,           0,            _T("ShowCaptions"),         },
    {Network_SET_THREAD_COUNT_1,        DIKEYBOARD_1,           0,            _T("SetThreadCountTo1"),    },
    {Network_SET_THREAD_COUNT_2,        DIKEYBOARD_2,           0,            _T("SetThreadCountTo2"),    },
    {Network_SET_THREAD_COUNT_4,        DIKEYBOARD_4,           0,            _T("SetThreadCountTo4"),    },
    {Network_SET_THREAD_COUNT_MAX,      DIKEYBOARD_X,           0,            _T("SetThreadCountToMax"),  },

    // Mouse Network mappings
    {Network_REL_ROTATE_LEFTRIGHT_AXIS, DIMOUSE_XAXIS,          0,            _T("Look left/right"),      },
    {Network_REL_ROTATE_UPDOWN_AXIS,    DIMOUSE_YAXIS,          0,            _T("Look up/down"),         },
    {Network_ACTION_2,                  DIMOUSE_BUTTON1,        0,            _T("Enable movement"),      },
};
...
NetworkScene::NetworkScene(
    ...
    , m_pNetworkTask(NULL) {
    m_pNetworkSystem = (NetworkSystem*)pSystem;
    // numbers
    m_aKeyboard["1"] = DIKEYBOARD_1;
    m_aKeyboard["2"] = DIKEYBOARD_2;
    m_aKeyboard["3"] = DIKEYBOARD_3;
    m_aKeyboard["4"] = DIKEYBOARD_4;
    m_aKeyboard["5"] = DIKEYBOARD_5;
    m_aKeyboard["6"] = DIKEYBOARD_6;
    m_aKeyboard["7"] = DIKEYBOARD_7;
    m_aKeyboard["8"] = DIKEYBOARD_8;
    m_aKeyboard["9"] = DIKEYBOARD_9;
    m_aKeyboard["0"] = DIKEYBOARD_0;
    // letters
    m_aKeyboard["A"] = DIKEYBOARD_A;
    m_aKeyboard["B"] = DIKEYBOARD_B;
    m_aKeyboard["C"] = DIKEYBOARD_C;
    m_aKeyboard["D"] = DIKEYBOARD_D;
    m_aKeyboard["E"] = DIKEYBOARD_E;
    m_aKeyboard["F"] = DIKEYBOARD_F;
    m_aKeyboard["G"] = DIKEYBOARD_G;
    m_aKeyboard["H"] = DIKEYBOARD_G;
    m_aKeyboard["I"] = DIKEYBOARD_I;
    m_aKeyboard["J"] = DIKEYBOARD_J;
    m_aKeyboard["K"] = DIKEYBOARD_K;
    m_aKeyboard["L"] = DIKEYBOARD_L;
    m_aKeyboard["M"] = DIKEYBOARD_M;
    m_aKeyboard["N"] = DIKEYBOARD_N;
    m_aKeyboard["O"] = DIKEYBOARD_O;
    m_aKeyboard["P"] = DIKEYBOARD_P;
    m_aKeyboard["Q"] = DIKEYBOARD_Q;
    m_aKeyboard["R"] = DIKEYBOARD_R;
    m_aKeyboard["S"] = DIKEYBOARD_S;
    m_aKeyboard["T"] = DIKEYBOARD_T;
    m_aKeyboard["U"] = DIKEYBOARD_U;
    m_aKeyboard["V"] = DIKEYBOARD_V;
    m_aKeyboard["W"] = DIKEYBOARD_W;
    m_aKeyboard["X"] = DIKEYBOARD_X;
    m_aKeyboard["Y"] = DIKEYBOARD_Y;
    m_aKeyboard["Z"] = DIKEYBOARD_Z;
    // function keys
    m_aKeyboard["F1"] = DIKEYBOARD_F1;
    m_aKeyboard["F2"] = DIKEYBOARD_F2;
    m_aKeyboard["F3"] = DIKEYBOARD_F3;
    m_aKeyboard["F4"] = DIKEYBOARD_F4;
    m_aKeyboard["F5"] = DIKEYBOARD_F5;
    m_aKeyboard["F6"] = DIKEYBOARD_F6;
    m_aKeyboard["F7"] = DIKEYBOARD_F7;
    m_aKeyboard["F8"] = DIKEYBOARD_F8;
    m_aKeyboard["F9"] = DIKEYBOARD_F9;
    m_aKeyboard["F10"] = DIKEYBOARD_F10;
    m_aKeyboard["F11"] = DIKEYBOARD_F11;
    m_aKeyboard["F12"] = DIKEYBOARD_F12;
    // other keys
    ...
    for (u32 h = 0; h < NUM_ACTIONMAPS; h++) {
        ...
        // set new hot key from Network.sdf into g_rgGameAction
        for (m_pHotKeyIter = m_pNetworkSystem->m_aHotKeys.begin(); m_pHotKeyIter != m_pNetworkSystem->m_aHotKeys.end(); m_pHotKeyIter++) {
            // find the hotkey that matches the current Network action
            if (_stricmp(m_pHotKeyIter->first, currKeyName) == 0) {
                // get the value of the key from Network.sdf
                newKey = m_pHotKeyIter->second->psKey;
                // get the appropriate DIKEYBOARD corresponding to the key
                keysIt = m_aKeyboard.find(newKey);
                // assign the DIKEYBOARD to the Network actions
...
NetworkScene::~NetworkScene(
    ...
    //
    // Release all of the enumerated Network devices and the direct Network system itself.
    //
    for (u32 i = 0; i < m_nDevices; i++) {
        SAFE_RELEASE(m_pNetworkDevices[i]);
    }
    ...
    //
    for (std::list<NetworkObject*>::iterator it = m_Objects.begin(); it != m_Objects.end(); it++) {
        delete *it;
    }
...
Error
NetworkScene::Initialize(
    std::vector<Properties::Property> Properties
) {
    ASSERT(!m_bInitialized);
    m_pNetworkTask = new NetworkTask(this);
    ASSERT(m_pNetworkTask != NULL);

    if (m_pNetworkTask == NULL) {
    ...
    //
    // Here, we obtain the interface to the directNetwork system.
    //
    HRESULT hr = DirectNetwork8Create(GetModuleHandle(NULL), DIRECTNetwork_VERSION, IID_IDirectNetwork8, (VOID**)&m_pDI, NULL);
    ...
    //
    // Here is where we setup the action map structure. We then enumerate the devices using this structure. DirectNetwork will
    ...
    m_diaf.dwBufferSize  = Network_BUFFER_SIZE;
    m_diaf.lAxisMin      = -10;
    m_diaf.lAxisMax      = 10;
    wcscpy_s(m_diaf.tszActionMap, _T("Smoke Demo Controls"));
    hr = m_pDI->EnumDevicesBySemantics(NULL, &m_diaf, (LPDIENUMDEVICESBYSEMANTICSCB) &NetworkScene::EnumSuitableDevicesCB, this, 0L);
...
ISystemObject* NetworkScene::CreateObject(const char* pszName, const char* pszType) {
    ...
    //
    NetworkObject* pObject = NULL;

    if (pszType && pszName) {
        pObject = new NetworkObject(this, pszType, pszName);
    } else {
        pObject = new NetworkObject(this);
    }
...
Error
NetworkScene::DestroyObject(
    ISystemObject* pSystemObject
) {
    ASSERT(m_bInitialized);
    ASSERT(pSystemObject != NULL);
    //
    // Cast to a NetworkObject so that the correct destructor will be called.
    //
    NetworkObject* pObject = reinterpret_cast<NetworkObject*>(pSystemObject);
    //
...
ISystemTask*
NetworkScene::GetSystemTask(
    void
) {
    return m_pNetworkTask;
}


System::Changes::BitMask
NetworkScene::GetPotentialSystemChanges(
    void
) {
...
const void*
NetworkScene::GetSystemChangeData(
...
void NetworkScene::NetworkUpdate(f32 DeltaTime) {
    DIDEVICEOBJECTDATA didod[Network_BUFFER_SIZE];
    ...
    // of Network so the data goes into an array which we need to cycle through.
    //
    for (u32 uDevice = 0; uDevice < m_nDevices; uDevice++) {
        DWORD dwElements = Network_BUFFER_SIZE;
        HRESULT hr = m_pNetworkDevices[uDevice]->Poll();
        ...
        hr = m_pNetworkDevices[uDevice]->GetDeviceData(sizeof(DIDEVICEOBJECTDATA), didod, &dwElements, 0);
        ...
        for (u32 i = 0; i < dwElements; i++) {
            ...
            BOOL bControlKeyValid = (
                                        (m_pHotKeyIter == m_pNetworkSystem->m_aHotKeys.end()) ||
            ...
            switch (didod[i].uAppData) {
                    //
                    // In the case of button (keyboard) Network we apply the change when the key is pressed (0x80) and
                ...
                case Network_SET_THREAD_COUNT_4:  // HOT KEY: Ctrl + 4
                    if (didod[i].dwData & 0x80) {
                        if (
                            (bControlKeyValid) &&
                ...
                case Network_SET_THREAD_COUNT_2:  // HOT KEY: Ctrl + 2
                    if (didod[i].dwData & 0x80) {
                        if (
                            (bControlKeyValid) &&
                            (g_Managers.pTask != NULL)
                ...
                case Network_SET_THREAD_COUNT_1:  // HOT KEY: Ctrl + 1
                    if (didod[i].dwData & 0x80) {
                        if (
                            (bControlKeyValid) &&
                            (g_Managers.pTask != NULL)
                ...
                case Network_SET_THREAD_COUNT_MAX: // HOT KEY: Ctrl + X
                    if (didod[i].dwData & 0x80) {
                        if (
                            (bControlKeyValid) &&
                            (g_Managers.pTask != NULL)
                ...
                case Network_ACTION_TOGGLE_OVERLAY_5:
                    nToggleOverlay++;

                case Network_ACTION_TOGGLE_OVERLAY_4:
                    nToggleOverlay++;

                case Network_ACTION_TOGGLE_OVERLAY_3:
                    nToggleOverlay++;

                case Network_ACTION_TOGGLE_OVERLAY_2:
                    nToggleOverlay++;

                case Network_ACTION_TOGGLE_OVERLAY_1:
                    nToggleOverlay++;
                    ...
                    if (bControlKeyValid) {
                        if (didod[i].dwData & 0x80) {
                            ...
                            std::list<NetworkObject*>& Objects = m_Objects;

                            for (std::list<NetworkObject*>::iterator it = Objects.begin(); it != Objects.end(); it++) {
                                NetworkObject* pObject = *it;
                ...
                case Network_QUIT:
                    ...
                    //
                    // In the case of relative Network we can get more than one update in the buffer so we need to
                    // concatanate them all together.
                    //
                case Network_REL_ROTATE_LEFTRIGHT_AXIS:
                ...
                case Network_REL_ROTATE_UPDOWN_AXIS:
                    if (m_MouseMoveEnabled) {
                        // NOTE: there's nothing special about the number 0.05f.  It was determined by trial
                        // and error in order to smooth out the movement
                    ...
                    //
                    // In the case of absolute Network we can get more than one update in the buffer but we only care
                    // about the last one i.e. what position the control stick is currently in.
                    //
                case Network_ABS_ROTATE_LEFTRIGHT_AXIS:
                    m_nRotateLeftRight = (f32)(long)didod[i].dwData;
                    break;

                case Network_ABS_ROTATE_UPDOWN_AXIS:
                    m_nRotateUpDown = (f32)(long)didod[i].dwData;
                    break;

                case Network_ABS_MOVE_LEFTRIGHT_AXIS:
                ...
                case Network_ABS_MOVE_FORWARDBACK_AXIS:
                    // NOTE: there's nothing special about the number 10.  It was determined by trial
                    // and error in order to smooth out the movement
                    m_nMoveForwardBack = (fMovementSpeed / 10) * (long)didod[i].dwData;
                    break;

                case Network_ABS_MOVE_UPDOWN:
                    // NOTE: there's nothing special about the number 10.  It was determined by trial
                    // and error in order to smooth out the movement
    ...
    if (bPositionModified || bOrientationModified || bUseFireHose) {
        for (std::list<NetworkObject*>::iterator it = Objects.begin(); it != Objects.end(); it++) {
            ...
            if (bUseFireHose) {
                mModified |= System::Changes::Network::Firehose;
            }
...
// combination keyboard/mouse.  After directNetwork applies the actionmap we can make changes to it if we wish.
//
BOOL NetworkScene::EnumSuitableDevicesCB(
    ...
    HRESULT hr;
    //
    // DirectNetwork will attempt to apply the action map to the currently enumerated device. We can examine
    // and make changes to the DIACTIONFORMAT structure if we wish to change anything.
    //
    hr = lpdid->BuildActionMap(&(((NetworkScene*)pvRef)->m_diaf), NULL, 0L);
    ...
    //
    hr = lpdid->SetActionMap(&(((NetworkScene*)pvRef)->m_diaf), NULL, 0L);
    ...
    //
    ((NetworkScene*)pvRef)->m_pNetworkDevices[((NetworkScene*)pvRef)->m_nDevices] = lpdid;
    ((NetworkScene*)pvRef)->m_pNetworkDevices[((NetworkScene*)pvRef)->m_nDevices]->AddRef();
    ((NetworkScene*)pvRef)->m_nDevices++;
    return true;
}

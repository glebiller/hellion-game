...
NetworkObject::NetworkObject(ISystemScene* pSystemScene) : ISystemObject(pSystemScene, NULL) {
    m_Type = Type_Controlled;
}

const Properties::Property NetworkObject::sm_kaDefaultProperties[] = {
...
NetworkObject::GetDesiredSystemChanges(
    void
) {
...
const WindowData* NetworkObject::GetWindowData(void) {

...
/// </summary>
class GraphicObjectStatWindow : public GraphicObjectWindow {
    ...
    protected:
        ...
        /// </summary>
        ~GraphicObjectStatWindow(void);

        /// <summary cref="GraphicObjectStatWindow::Update">
    ...
    private:
        ...
        /// <summary cref="GraphicObjectStatWindow::GetWindowDataUpdate">

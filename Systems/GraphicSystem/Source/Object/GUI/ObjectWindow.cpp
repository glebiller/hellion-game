...
const Properties::Property GraphicObjectWindow::sm_kaDefaultProperties[] = {
...
GraphicObjectWindow::~GraphicObjectWindow(void) {
...
//-----------------------------------------------------------------------------
//
// GraphicObjectWindow::Initialize
//
...
void GraphicObjectWindow::GetProperties(
...
void GraphicObjectWindow::SetProperties(Properties::Array Properties) {
    //
...
//-----------------------------------------------------------------------------
//
// GraphicObjectWindow::CreateMaterial
//
...
//
//-----------------------------------------------------------------------------
void GraphicObjectWindow::CreateMaterial() {
    //----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
//
// GraphicObjectWindow::SetCaption
//
// Changes the caption of the window.
//
//-----------------------------------------------------------------------------
void GraphicObjectWindow::SetCaption(std::string szText) {
...
//-----------------------------------------------------------------------------
//
// GraphicObjectWindow::SetText
//
// Changes the text that is displayed in the window.
//
//-----------------------------------------------------------------------------
void GraphicObjectWindow::SetText(std::string szText) {
    if (m_pTextAreaBody) {
...
//-----------------------------------------------------------------------------
//
// GraphicObjectWindow::ApplyChanges
//
// Makes changes to the window.
//
//-----------------------------------------------------------------------------
void GraphicObjectWindow::ApplyChanges(const WindowData* pData) {
    if (!pData)
    { return; }
...
//-----------------------------------------------------------------------------
//
// GraphicObjectWindow::GetDesiredSystemChanges
//
// Lets the CCM know what changes we would like to know about.
//
//-----------------------------------------------------------------------------
System::Types::BitMask GraphicObjectWindow::GetDesiredSystemChanges(void) {
    return System::Changes::Graphics::GUI;
}

//-----------------------------------------------------------------------------
//
// GraphicObjectWindow::ChangeOccurred
//
...
//
//-----------------------------------------------------------------------------
Error GraphicObjectWindow::ChangeOccurred(
    ISubject* pSubject,

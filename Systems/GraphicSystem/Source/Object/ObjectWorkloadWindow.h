...
/// </summary>
class GraphicObjectWorkloadWindow : public GraphicObjectWindow {
        friend OGREGraphicsScene;

    protected:

        /// <summary cref="GraphicObjectWorkloadWindow::GraphicObjectWorkloadWindow">
        ...
        GraphicObjectWorkloadWindow(ISystemScene* pSystemScene, const char* pszName);

        /// <summary cref="GraphicObjectWorkloadWindow::~GraphicObjectWorkloadWindow">
        ///     Basic destructor; the only one.
        /// </summary>
        ~GraphicObjectWorkloadWindow(void);

        /// <summary cref="GraphicObjectWorkloadWindow::Update">
    ...
    private:
        ...
        /// <summary cref="GraphicObjectWorkloadWindow::GetWindowDataUpdate">

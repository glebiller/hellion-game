...
const Properties::Property GraphicObjectMesh::sm_kaDefaultProperties[] = {
...
void
GraphicObjectMesh::GetProperties(
...
Error
GraphicObjectMesh::ChangeOccurred(
    ISubject* pSubject,
    ...
    if (ChangeType & (System::Changes::Geometry::Position |
        ...
        if (m_pNode && NeedsLocking(m_pNode)) {
            SCOPED_SPIN_LOCK(OGREGraphicsScene::m_mutex);
        }
...
void GraphicObjectMesh::GeometryChanged(System::Changes::BitMask ChangeType, IGeometryObject* pGeometryObject) {
    if (ChangeType & (System::Changes::Geometry::Position | System::Changes::Physics::Position)) {
...
GraphicObjectMesh::GetPotentialSystemChanges(
    void
) {
...
u32
GraphicObjectMesh::GetSubMeshCount(
    void
) {
...
u32
GraphicObjectMesh::GetIndexDeclaration(
...
u32
GraphicObjectMesh::GetVertexDeclarationCount(
    In  u16 nSubMeshIndex
) {
    ASSERT(m_pEntity != NULL);
    Ogre::SubMesh* pSubMesh = m_pEntity->getMesh()->getSubMesh(nSubMeshIndex);
...
void
GraphicObjectMesh::GetVertexDeclaration(
...
u32
GraphicObjectMesh::GetIndexCount(
    In  u16 nSubMeshIndex
) {
    ASSERT(m_pEntity != NULL);
    Ogre::SubMesh* pSubMesh = m_pEntity->getMesh()->getSubMesh(nSubMeshIndex);
...
u32
GraphicObjectMesh::GetVertexCount(
    In  u16 nSubMeshIndex
) {
    ASSERT(m_pEntity != NULL);
    Ogre::SubMesh* pSubMesh = m_pEntity->getMesh()->getSubMesh(nSubMeshIndex);
...
u32
GraphicObjectMesh::GetStreamsChanged(
    void
) {
...
GraphicObjectMesh::BuildNormalsTemplate(
    u32 nSubMesh
) {
...
void
GraphicObjectMesh::SetupNormalsAndTangentsDisplay(
    void
) {
...
void
GraphicObjectMesh::SetupCaptions(
    void
) {
    if (m_pCaption) {
        return;

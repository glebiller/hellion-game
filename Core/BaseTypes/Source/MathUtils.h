...
namespace Math {
    ...
    struct Quaternion {
        ...
        const Quaternion& Set( In Vector3& Angles );*/
    ...
    // Min/Max for Vector3
    inline Vector3 Min(Vector3& x, Vector3& y) { return (x.Magnitude() < y.Magnitude()) ? x : y; }
    inline Vector3 Max(Vector3& x, Vector3& y) { return (x.Magnitude() > y.Magnitude()) ? x : y; }

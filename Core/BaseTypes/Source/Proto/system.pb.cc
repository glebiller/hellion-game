...
const ::google::protobuf::EnumDescriptor* System_Type_descriptor_ = NULL;
...
void protobuf_AssignDesc_System_2eproto() {
  ...
  System_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      sizeof(System));
  System_Type_descriptor_ = System_descriptor_->enum_type(0);
}
...
void protobuf_AddDesc_System_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "PUT\020\004\022\n\n\006PHYSIC\020\005B;\n)fr.kissy.hellion.de"
    "finition.encoder.protoB\013SystemProto\210\001\000", 238);
...
const ::google::protobuf::EnumDescriptor* System_Type_descriptor() {
  protobuf_AssignDescriptorsOnce();
  return System_Type_descriptor_;
}
...
#ifndef _MSC_VER
const System_Type System::AI;
const System_Type System::AUDIO;
const System_Type System::GEOMETRY;
const System_Type System::GRAPHIC;
const System_Type System::INPUT;
const System_Type System::PHYSIC;
const System_Type System::Type_MIN;
const System_Type System::Type_MAX;
const int System::Type_ARRAYSIZE;
#endif  // _MSC_VER
#ifndef _MSC_VER
      ...
      case 1: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
          ...
          if (::System_Type_IsValid(value)) {
            set_type(static_cast< ::System_Type >(value));
          } else {

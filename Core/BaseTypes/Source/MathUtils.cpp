 ...
 *
 * @param [in,out]	a	The Vector3&amp; to process.
 */
 ...
 */
const Matrix4x4& Matrix4x4::Transformation(const Vector3& Translation, const Quaternion& Orientation) {
 ...
 */
void Matrix4x4::GetOrientation(Quaternion& Orientation) const {
 ...
 *
 * @param	Orientation	The orientation.
 * @return	The matrix with orientation changed.
 */
const Matrix4x4& Matrix4x4::SetOrientation(const Quaternion& Orientation) {

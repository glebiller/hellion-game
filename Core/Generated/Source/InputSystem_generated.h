...
enum InputSystemPropertyData {
  InputSystemPropertyData_NONE = 0,
  InputSystemPropertyData_InputSystemName = 1
};
...
struct InputSystemName : private flatbuffers::Table {
...
struct InputSystemProperty : private flatbuffers::Table {
...
inline flatbuffers::Offset<InputSystemProperty> CreateInputSystemProperty(flatbuffers::FlatBufferBuilder &_fbb,
   InputSystemPropertyData property_type = InputSystemPropertyData_NONE,
...
struct InputSystem : private flatbuffers::Table {
...
inline bool VerifyInputSystemPropertyData(flatbuffers::Verifier &verifier, const void *union_obj, InputSystemPropertyData type) {
  switch (type) {
    case InputSystemPropertyData_NONE: return true;
    case InputSystemPropertyData_InputSystemName: return verifier.VerifyTable(reinterpret_cast<const InputSystemName *>(union_obj));
